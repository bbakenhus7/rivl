...
class BattlePassSeason {
  ...
  static List<BattlePassReward> generateDefaultRewards() {
    return [
      ...
      BattlePassReward(level: 1, tier: RewardTier.premium, type: RewardType.giftcard, name: '\$5 Nike Gift Card', description: 'Nike.com credit', value: 5),
      // Tier 2 - 250 XP
      ...
      BattlePassReward(level: 2, tier: RewardTier.premium, type: RewardType.giftcard, name: '\$5 Gymshark Gift Card', description: 'Gymshark.com credit', value: 5),
      // Tier 3 - 500 XP
      ...
      BattlePassReward(level: 3, tier: RewardTier.premium, type: RewardType.giftcard, name: '\$10 Lululemon Gift Card', description: 'Lululemon.com credit', value: 10),
      // Tier 4 - 1,000 XP
      ...
      BattlePassReward(level: 4, tier: RewardTier.premium, type: RewardType.giftcard, name: '\$10 Nike Gift Card', description: 'Nike.com credit', value: 10),
      // Tier 5 - 1,750 XP
      ...
      BattlePassReward(level: 5, tier: RewardTier.premium, type: RewardType.giftcard, name: '\$15 Amazon Gift Card', description: 'Fitness gear shopping', value: 15),
      // Tier 6 - 2,500 XP
      ...
      BattlePassReward(level: 6, tier: RewardTier.premium, type: RewardType.giftcard, name: '\$15 Gymshark Gift Card', description: 'Gymshark.com credit', value: 15),
      // Tier 7 - 3,500 XP
      ...
      BattlePassReward(level: 7, tier: RewardTier.premium, type: RewardType.giftcard, name: '\$20 Lululemon Gift Card', description: 'Lululemon.com credit', value: 20),
      // Tier 8 - 5,000 XP
      ...
      BattlePassReward(level: 8, tier: RewardTier.premium, type: RewardType.giftcard, name: '\$25 Nike Gift Card', description: 'Nike.com credit', value: 25),
      // Tier 9 - 7,000 XP
      ...
      BattlePassReward(level: 9, tier: RewardTier.premium, type: RewardType.giftcard, name: '\$25 Amazon Gift Card', description: 'Fitness gear shopping spree', value: 25),
      // Tier 10 - 10,000 XP
      ...
      BattlePassReward(level: 10, tier: RewardTier.premium, type: RewardType.giftcard, name: '\$50 Amazon Gift Card', description: 'Ultimate fitness shopping spree', value: 50),
    ];
  }
