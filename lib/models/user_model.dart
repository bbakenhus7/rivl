...
class UserModel {
  ...
  factory UserModel.fromFirestore(DocumentSnapshot doc) {
    ...
    return UserModel(
      ...
      totalChallenges: (data['totalChallenges'] as num? ?? 0).toInt(),
      wins: (data['wins'] as num? ?? 0).toInt(),
      losses: (data['losses'] as num? ?? 0).toInt(),
      draws: (data['draws'] as num? ?? 0).toInt(),
      winRate: (data['winRate'] as num? ?? 0).toDouble(),
      totalSteps: (data['totalSteps'] as num? ?? 0).toInt(),
      ...
      battlePassLevel: (data['battlePassLevel'] as num? ?? 1).toInt(),
      coins: (data['coins'] as num? ?? 0).toInt(),
      referralCode: data['referralCode'] ?? '',
      referredBy: data['referredBy'],
      referralCount: (data['referralCount'] as num? ?? 0).toInt(),
      referralEarnings: (data['referralEarnings'] as num? ?? 0).toDouble(),
